...
function fs_styles()
{
	...
	wp_enqueue_style('main-styles', get_template_directory_uri() . $file, [], fs_asset_hash($file), 'all');
}
...
function fs_admin_styles()
{
	...
	wp_enqueue_style('main-admin-styles', get_template_directory_uri() . $file, [], fs_asset_hash($file), 'all');
}
...
function fs_scripts()
{
	...
	$file = '/js/main' . $min . '.js';
	wp_enqueue_script('main-scripts', get_template_directory_uri() . $file, [], fs_asset_hash($file), true);
}
...
function fs_admin_scripts()
{
	...
	wp_enqueue_script('main-admin-scripts', get_template_directory_uri() . $file, [], fs_asset_hash($file), true);
}
